...
--
-- Host: localhost    Database: medicinereminder
-- ------------------------------------------------------
...
CREATE TABLE `medicine_reminder` (
  ...
  PRIMARY KEY (`medicineID`,`reminderID`),
  KEY `reminderID` (`reminderID`),
  CONSTRAINT `medicine_reminder_ibfk_1` FOREIGN KEY (`medicineID`) REFERENCES `medicine` (`medicineID`),
  CONSTRAINT `medicine_reminder_ibfk_2` FOREIGN KEY (`reminderID`) REFERENCES `reminder` (`reminderID`)
...
-- Dump completed on 2025-04-28 12:50:05
